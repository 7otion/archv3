...
import { CopyIcon, HomeIcon, RefreshCwIcon } from 'lucide-react';

import { Button } from '@/components/button';

import { WindowActions } from '@/layout/window-actions';
				...
				<main>
					...
					<div className="flex h-screen w-screen items-center justify-center">
						<div className="relative max-w-3xl rounded-md p-6  text-left text-white">
							...
							<pre className="mt-2 max-h-100 overflow-auto rounded-md border border-gray-700 bg-black p-4 text-sm">
